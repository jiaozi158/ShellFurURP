...
Properties
{
    ...
    [Space][Space]
    [Toggle(_GEOM_INSTANCING)] _GeomInstancing("More Shell Amount", Float) = 0
    ...
    [Space][Enum(Linear, 0, Quadratic, 1)]_BentType("Bent Type", float) = 1
    ...
    [Toggle(_NO_FUR_SHADOW)] _NoFurShadow("Mesh Shadow Only", Float) = 1
